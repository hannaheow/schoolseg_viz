This repo contains a quarto document which can be used to create a static visual of state-level school segregation by school funding adequacy (saved as a png in the outputs folder). 
